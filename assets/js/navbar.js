...
function getNavItemsForRole(role) {
    const navItems = {
        admin: [
            ...
            '    <li><a class="dropdown-item" href="admin-videos.html"><i class="fas fa-video me-2"></i>View All Videos</a></li>',
            '    <li><a class="dropdown-item" href="user-management.html"><i class="fas fa-users me-2"></i>Manage Users</a></li>',
            '    <li><hr class="dropdown-divider"></li>',
            '    <li><a class="dropdown-item" href="#" onclick="showAlert(\'Analytics coming soon!\', \'info\')"><i class="fas fa-chart-bar me-2"></i>View Analytics</a></li>',
            '  </ul>',
            '</li>'
        ],
        editor: [
            '<li class="nav-item">',
            '  <a class="nav-link" href="editor-videos.html" data-page="editor-videos">',
            ...
            '  </a>',
            '  <ul class="dropdown-menu">',
            '    <li><a class="dropdown-item" href="editor-upload.html"><i class="fas fa-upload me-2"></i>Upload Video</a></li>',
            '    <li><a class="dropdown-item" href="editor-videos.html"><i class="fas fa-edit me-2"></i>My Videos</a></li>',
            '    <li><hr class="dropdown-divider"></li>',
            '    <li><a class="dropdown-item" href="#" onclick="showAlert(\'Analytics coming soon!\', \'info\')"><i class="fas fa-chart-line me-2"></i>View Analytics</a></li>',
            '  </ul>',
            '</li>'
        ],
        viewer: [
            '<li class="nav-item">',
            '  <a class="nav-link" href="viewer-videos.html" data-page="viewer-videos">',
            '    <i class="fas fa-video me-1"></i>',
            '    <span>Browse Videos</span>',
            '  </a>',
            '</li>',
            '<li class="nav-item">',
            '  <a class="nav-link" href="viewer-history.html" data-page="viewer-history">',
            ...
            '  </a>',
            '  <ul class="dropdown-menu">',
            '    <li><a class="dropdown-item" href="viewer-videos.html"><i class="fas fa-video me-2"></i>Browse Videos</a></li>',
            '    <li><a class="dropdown-item" href="viewer-history.html"><i class="fas fa-history me-2"></i>Purchase History</a></li>',
            '  </ul>',
            '</li>'
        ]
    };
