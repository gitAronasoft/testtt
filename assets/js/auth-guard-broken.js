...
class AuthGuard {
    ...
    async validateSession() {
        ...
        try {
            ...
            const apiServiceAvailable = await this.waitForAPIService();
    ...
    async logout() {
        try {
            ...
            if (apiServiceAvailable && window.apiService) {
    ...
    async waitForAPIService() {
        ...
        // Return whether API service is available, don't throw error
